...
from marshmallow import fields, validate, validates_schema, EXCLUDE, pre_load
from .....messaging.models import BaseModel, BaseModelError, BaseModelSchema, BaseRecord, BaseRecordSchema
...
class TypedIDSchema(BaseModelSchema):
...
class IssuerSchema(BaseModelSchema):
...
class VerifiableCredential(BaseRecord):
...
class VerifiableCredentialSchema(BaseRecordSchema):
...
class VerifiablePresentation(BaseRecord):
...
class VerifiablePresentationSchema(BaseRecordSchema):
    """Single Field Schema."""
